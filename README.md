...
- 💻 現在フリーランスエンジニアとして活動しており、主にAWSやPythonを利用したシステム開発二従事しています。
- 🦡 神戸大学経済学部経済学科を卒業
- 🏃‍♀️ 業務以外では、トレーニング・ランニング・トレッキング・柔術を楽しんでいます・
- 🌱 Webアプリ開発のスキル（特にTypeScript）とデータ分析スキル（Pythonを利用）の向上を目指しています。
- 🍖 健康維持のため。料理を勉強中です。
